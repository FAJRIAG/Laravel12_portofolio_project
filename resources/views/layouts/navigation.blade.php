<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('set_locale', 'id')">
                            Indo
                        </x-dropdown-link>
                        <x-dropdown-link :href="route('set_locale', 'ja')">
                            JP
                        </x-dropdown-link>
                    </x-slot>
                </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4 text-xs font-semibold text-gray-400 uppercase">
                Language
            </div>
            <x-responsive-nav-link :href="route('set_locale', 'en')" :active="app()->getLocale() == 'en'">
                English
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('set_locale', 'id')" :active="app()->getLocale() == 'id'">
                Indonesia
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('set_locale', 'ja')" :active="app()->getLocale() == 'ja'">
                Japanese
            </x-responsive-nav-link>
        </div>
